...
def Preprocess(FileName):
	...
	Y_temp=np.zeros((np.shape(y)[0],10))
...
X,y=Preprocess('/home/aaron/Desktop/信道预测/Python version/DataCL.npz')#X: 2000*100, y:2000*1
...
layer1, regularizer_1 = add_layer(x, np.shape(X_train)[1], hidden_num, activation_function=tf.nn.relu)
#layer2 = add_layer(layer1, hidden_num, 40, activation_function=tf.nn.relu)
y_result, regularizer_2 = add_layer(layer1, hidden_num, 10, activation_function = None)
